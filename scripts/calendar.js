// Fetches 3 upcoming calendar posts and adds them to the DATA.
async function fetchNextCalendarEvents(upcomingN) {
  const CALENDAR_URL = DATA.events_page.content_segment1.calendar_url;
  formatGoogleCalendar.init({
    ...
    dayNames: false,
    pastTopN: -1,
    upcomingTopN: upcomingN,
    itemsTagName: "li",
    upcomingSelector: "#events-upcoming",
    pastSelector: "#events-past",
    recurringEvents: true,
    upcomingHeading: "<h2 hidden>Upcoming events</h2>",
...
/*
 * Google Calendar Formatting Library is used for getting the next TOP 3 activities from the given Google Calendar URL.
 * This library was retrieved from the following blog post: https://www.milanlund.com/blog/javascript-library-google-calendar.
 * The below code was copied from Milan Lund's Github Repository: https://github.com/MilanLund/FormatGoogleCalendar.
 */
!(function(e) {
  function t(r) {
