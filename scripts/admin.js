...
async function loadHTML() {
  ...
  let homeSlideshow = new Vue({
    el: "#home-slideshow",
    data: {
      images: DATA.home_page.slideshow
    }
  });
  ...
  let aboutSlideshow = new Vue({
    el: "#about-slideshow",
    data: {
      images: DATA.about_page.slideshow
    }
  });
  ...
  let repSlideshow1 = new Vue({
    el: "#rep-slideshow1",
    data: {
      images: DATA.representatives_page.slideshow1
    }
  });
  ...
  let repSlideshow2 = new Vue({
    el: "#rep-slideshow2",
    data: {
      images: DATA.representatives_page.slideshow2
    }
  });
  ...
  voiceHeader = new Vue({
    el: "#voice-output",
    data: {
      forms: Object.values(DATA.voice).reverse(),
      formIndex: 0
    },
    methods: {
      next: function() {
      ...
      deleteForm: function() {
        ...
        firebase.database().ref("/voice/").set({
          ...newForms
        });
        this.next();
      }
  ...
  contactHeader = new Vue({
    el: "#contact-output",
    data: {
      forms: Object.values(DATA.contact).reverse(),
      formIndex: 0
    },
    methods: {
      next: function() {
  ...
  newsPage = new Vue({
    el: "#news-output",
    data: {
      posts: DATA.news_page.content_segment1.posts,
      postIndex: 0
    },
    methods: {
      next: function() {
